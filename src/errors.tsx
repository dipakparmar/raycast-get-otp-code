/* 
Copied from https://github.com/raycast/extensions/blob/main/extensions/apple-notes/src/errors.tsx
...
const permissionErrorMarkdown = `## Raycast needs full disk access in order to display your Messages.

![Full Disk Access Preferences Pane](${(path.join(environment.assetsPath, "full-disk-access.png"))})
